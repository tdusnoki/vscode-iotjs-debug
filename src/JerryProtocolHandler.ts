...
export class JerryDebugProtocolHandler {
  ...
  public decodeMessage(format: string, message: Uint8Array, offset: number): Array<any> {
  ...
  public onSourceCodeName(data: Uint8Array) {
  ...
  private onFunctionName(data: Uint8Array) {
  ...
  public releaseFunction(byteCodeCP: number) {
  ...
  private onReleaseByteCodeCP(data: Uint8Array) {
  ...
  public getBreakpoint(breakpointData: Array<number>): JerryMessageBreakpointHit {
  ...
  public getActiveBreakpoint(breakpointId: number) {
  ...
  public onExceptionStr(data: Uint8Array) {
